...
export default function MultiImageDropZone({ hooks, title }) {
  ...
  return (
    <div className="max-w-lg grid grid-cols-1 gap-y-5 sm:grid-cols-2 sm:gap-x-5 justify-center">
      <Dropzone
        w={240}
        h={240}
        loading={isLoading}
        ...
        <div className="flex items-center justify-center h-[200px]">
          <Text align="center">Drop your image</Text>
        </div>
      </Dropzone>
